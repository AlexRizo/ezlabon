export const ModalComponent = ({ isOpen }) => {
    ...
    return (
        <div className="w-screen h-screen fixed z-[9999] flex items-center justify-center top-0">
            <div className="bg-black/40 w-full h-full absolute" onClick={ quitModal }>
            </div>
            <div className="bg-white px-10 flex flex-col relative">
                    <div className="flex justify-end pt-10 mb-20 cursor-pointer" onClick={ quitModal }>
                        <svg id="Grupo_111" data-name="Grupo 111" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="31.531" height="31.531" viewBox="0 0 31.531 31.531">
                            <defs>
                    ...
                    <div className="text-[#2E5AFC] text-5xl w-[600px] text-center pb-32">
