...
export const ContactoPage = () => {
    ...
    return (
        <>
            <IndexComponent title='¡Pon tu carga en nuestras manos!' img='custom-bg-contacto-page' custom='bg-bottom' />

            <div className='container m-auto'>
                <h1 className='text-[#2E5AFC] text-6xl font-semibold text-center py-16'>Cotiza tu transporte de carga:</h1>
                <form onSubmit={ onSubmit } className='bg-[#F5F5F5] px-32 py-20 flex flex-col gap-16'>
                    <div className='flex flex-col gap-4 text-xl'>
                        <h2 className='text-[#2E5AFC] text-2xl font-semibold'>Datos Personales:</h2>
                        <input className='placeholder:opacity-75 p-4 text-black font-normal' type="text" name="nombre" placeholder='Nombre:' required />
                        <input className='placeholder:opacity-75 p-4 text-black font-normal' type="text" name="empresa" placeholder='Empresa:' required />
                        <input className='placeholder:opacity-75 p-4 text-black font-normal' type="email" name="correo" placeholder='Correo Electrónico:' required />
                        <input className='placeholder:opacity-75 p-4 text-black font-normal' type="tel" name="telefono" placeholder='Teléfono:' required />
                    </div>

                    <div className='flex flex-col gap-4 text-xl'>
                        <h2 className='text-[#2E5AFC] text-2xl font-semibold'>Detalles de solicitud de transporte:</h2>
                        <input
                            className='placeholder:opacity-75 p-4 text-black font-normal'
                            type="number"
                            name="cantidad"
                            placeholder='Número de contenedores o plataformas para carga suelta:'
                            required
                        />
                        <input className='placeholder:opacity-75 p-4 text-black font-normal' type="text" name="tipo" placeholder='Tipo de mercancía:' required />
                        <input className='placeholder:opacity-75 p-4 text-black font-normal' type="text" name="peso" placeholder='Peso de mercancía:' required />
                        <input className='placeholder:opacity-75 p-4 text-black font-normal' type="text" name="carga" placeholder='¿Dónde se carga?' required />
                        <input className='placeholder:opacity-75 p-4 text-black font-normal' type="text" name="descarga" placeholder='¿Dónde se descarga?' required />
                        <textarea className='placeholder:opacity-75 p-4 text-black font-normal resize-none' name="servicios" rows="3" placeholder='¿Qué otro servicio(s) necesitas?'></textarea>
                        <textarea className='placeholder:opacity-75 p-4 text-black font-normal resize-none' name="detalles" rows="3" placeholder='¿Hay algún otro detalle que quieras agregar?'></textarea>
                    </div>
                    <div className='flex items-center justify-center mt-5'>
                        <ButtonComponent content='Enviar' custom='font-bold px-20 py-4' />
                    </div>
                </form>
            </div>
            ...
            <div className='mt-24 container m-auto'>
                <div className='w-full h-[580px]'>
                    <iframe 
                        src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d2513.1202251344025!2d-103.72287061831864!3d19.213851418441966!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTnCsDEyJzUwLjEiTiAxMDPCsDQzJzE4LjkiVw!5e0!3m2!1ses-419!2sus!4v1719695330926!5m2!1ses-419!2sus"
                        height="580"
                        style={{ border: 0 }}
                        allowFullScreen=""
                        loading="lazy"
                ...
                <div className="px-40 pb-20">
                    <h1 className='text-2xl text-[#2E5AFC] font-bold mb-16 mt-16'>Con base en Manzanillo y Colima, con cobertura en todo el territorio Nacional.</h1>
                    <div className='flex flex-col gap-10'>
                        <div className='text-2xl flex items-center just gap-5 text-black'>
                            <div className='w-[40px] flex justify-center'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="19.38" height="36.479" viewBox="0 0 19.38 36.479">
                        ...
                        <div className='text-2xl flex items-center just gap-5 text-black'>
                            <div className='w-[40px] flex justify-center'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="28.807" height="25.481" viewBox="0 0 28.807 25.481">
                        ...
                        <div className='text-2xl flex items-center just gap-5 text-black'>
                            <div className='w-[40px] flex justify-center'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="37.419" height="37.409" viewBox="0 0 37.419 37.409">
                        ...
                        <div className='flex gap-36'>
                            <div className='flex flex-col gap-10'>
                                <div className="flex items-center just gap-5 text-black" >
                                    <div className='w-[40px] flex justify-center'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="39.524" height="26.696" viewBox="0 0 39.524 26.696">
